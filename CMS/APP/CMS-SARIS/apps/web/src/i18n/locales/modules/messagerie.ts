...
export const messagerie = {
  fr: {
    ...
    messageSupprime: 'Ce message a été supprimé',
    messageSupprimeParMoi: 'Vous avez supprimé ce message',
    messageSupprimePar: '{{nom}} a supprimé ce message',
  ...
  en: {
    ...
    messageSupprime: 'This message was deleted',
    messageSupprimeParMoi: 'You deleted this message',
    messageSupprimePar: '{{nom}} deleted this message',
    format: 'Formatting',
    formatBold: 'Bold',
    formatItalic: 'Italic',
