...
**Version** 1.1 · **Date** 2026-07-06 · **Statut** Brouillon · **Release** MVP · **Historique** : v1.0 création · v1.1 (2026-07-06) : précision EF-03-13 (regroupement d'affichage) + fil d'Ariane
...
- **EF-03-13** — L'écran d'administration affiche les paramètres **groupés** et, par paramètre : son libellé i18n, son état (**Personnalisé** vs **Valeur par défaut**), la valeur par défaut, un contrôle adapté au type, et les actions **Enregistrer** (si modifié) / **Réinitialiser** (si personnalisé). *(Précision 2026-07-06 : `GenerauxTab.tsx` accepte une ou plusieurs clés de groupe — les groupes « Sécurité & authentification » et « Politique de mot de passe » sont désormais rendus **ensemble** sous UNE seule section de sous-navigation « Sécurité & mot de passe » (une carte par groupe technique, mais un seul point d'entrée dans le menu), tandis que « Notifications » garde sa propre section. Le catalogue backend `PARAMETRES_CATALOGUE` et ses **3 groupes** ne changent pas : seul le **regroupement d'affichage** de la sous-navigation a évolué.)*
