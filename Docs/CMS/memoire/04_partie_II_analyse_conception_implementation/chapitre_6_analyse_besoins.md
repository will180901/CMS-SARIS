...
> 8 figure(s) · 15 tableau(x) dans ce chapitre.

L'analyse des besoins est la première étape formelle de la branche fonctionnelle de 2TUP. Elle transforme une compréhension du métier en un ensemble d'exigences numérotées, d'acteurs identifiés et de cas d'utilisation spécifiés. Toute la conception s'appuiera dessus. Les besoins présentés ici ont été établis par deux voies complémentaires. Les besoins exprimés proviennent du recueil de l'existant : ils disent ce que le centre demandait. Les besoins reconstitués proviennent de l'analyse du système réalisé — routes, permissions, écrans, règles — et disent ce que le système réalise.

Les deux ensembles ne se recouvrent pas exactement. Leur confrontation est présentée plus loin.

## 6.1 Besoins fonctionnels

Vingt-trois besoins fonctionnels ont été identifiés. Chacun est rattaché à l'élément du système qui le réalise, ce qui permet de vérifier qu'aucun besoin n'est déclaré sans preuve.
...
Une exigence attendue manque à cette liste, et son absence doit être justifiée. Aucune exigence chiffrée de temps de réponse n'a été établie. Elle ne figure ni dans le recueil, ni sous forme mesurable dans le code, et aucune campagne de mesure n'a été conduite. Annoncer un seuil serait une invention. Le sujet est renvoyé aux perspectives.
...
## 6.3 Confrontation des besoins exprimés au périmètre

Les dix-huit besoins recueillis lors des entretiens se répartissent ainsi une fois confrontés au périmètre retenu.
...
La synthèse de cette confrontation tient en quatre nombres : six besoins couverts, quatre partiellement couverts, huit hors du périmètre retenu, et aucun besoin non couvert à l'intérieur du périmètre. Cette dernière valeur est la plus importante. Elle établit que le projet n'a pas laissé de trou dans le domaine qu'il s'est donné.

## 6.4 Acteurs et frontière du système

Le système ne connaît que trois rôles, et les acteurs primaires en découlent directement.
...
Soixante-cinq cas d'utilisation ont été identifiés, répartis en douze modules fonctionnels. Le tableau ci-dessous en donne la répartition par module.
...
Les cinq diagrammes suivants représentent chaque package. Ils ont été préférés à un diagramme unique : soixante-cinq cas d'utilisation sur une seule planche seraient illisibles au format A4, et la lisibilité d'un diagramme conditionne son utilité.
...
## 6.9 Descriptions textuelles détaillées

Conformément au plan de rédaction de l'école, deux descriptions textuelles complètes figurent dans le corps du mémoire.

### UC43 — Émettre un bon de pharmacie

Ce cas porte la règle métier la plus structurante du système : tous les patients n'ouvrent pas droit à la prise en charge des médicaments. Un soignant génère, à partir d'une ordonnance pharmaceutique validée, un bon permettant au patient de retirer ses médicaments. Les préconditions sont les suivantes. Le soignant est connecté et dispose du droit de création de bon. Une consultation existe. Et une ordonnance de type pharmaceutique, rattachée à cette consultation, est à l'état validé.

En sortie, un bon de pharmacie existe à l'état en attente. Il est rattaché à l'ordonnance et à la consultation, il est imprimable, et sa création est journalisée.

Le scénario nominal se déroule ainsi. Le soignant ouvre l'ordonnance validée, puis demande la génération d'un bon. Le système lit la catégorie du patient, interroge la matrice des droits par catégorie pour la prestation médicament, et constate que la catégorie est couverte. Il crée alors le bon à l'état en attente, en reprenant les lignes de l'ordonnance, et journalise la création. Le soignant imprime le bon et le remet au patient.
...
Le soignant met fin à une consultation en enregistrant sa conclusion et, le cas échéant, une décision médicale qui déclenche la suite de la prise en charge. Les préconditions sont qu'une consultation soit ouverte et conduite par l'acteur. Un examen clinique et au moins un diagnostic ont normalement été saisis.

En sortie, la consultation est clôturée et n'est plus modifiable. La visite parente est clôturée. Une notification est diffusée. Et selon la décision, une évacuation ou un suivi de traitement a été créé. Dans le scénario nominal, le soignant rédige sa conclusion, indique s'il y a lieu la durée de repos prescrite, puis choisit une décision médicale ou n'en choisit aucune.

Le système vérifie que la consultation n'est pas déjà dans un état terminal. Il enregistre la conclusion et la décision, fait passer la consultation à l'état clôturé, puis la visite parente également. Il émet enfin une notification portant l'intitulé de la décision.
...
L'analyse a établi vingt-trois besoins fonctionnels et treize besoins non fonctionnels, tous rattachés à une preuve dans le système réalisé. Elle a identifié trois acteurs primaires et trois acteurs secondaires. Elle a recensé soixante-cinq cas d'utilisation répartis en douze modules, dont trente-sept de priorité haute, et a spécifié en détail les plus structurants. La confrontation des besoins exprimés aux exigences retenues a produit un résultat qu'il faut souligner. Aucun besoin n'est resté non couvert à l'intérieur du périmètre : les huit besoins sans réponse relèvent tous de domaines explicitement écartés.
