...
La Société Agricole de Raffinage Industriel du Sucre est l'une des principales entreprises agro-industrielles de la République du Congo. Son histoire s'inscrit dans un processus de développement industriel amorcé dans la vallée du Niari à la fin des années 1940.

**Tableau 1.1 — Grandes étapes de l'histoire de SARIS-CONGO**

| Année | Événement |
|---|---|
| 1947 | Installation de la famille Vilgrain dans la vallée du Niari, avec une activité d'huilerie d'arachides |
| 1956 | Création de la Société Industrielle et Agricole du Niari et première sucrerie à Nkayi |
| 1965 | Création de la Société Sucrière du Niari, d'une capacité de 5 000 tonnes de canne par jour |
| 1970 | Fusion des deux sociétés en Société Industrielle et Agricole du Congo |
| 1991 | Privatisation : la structure devient SARIS-CONGO |
...
| 2025 | Mise en service de la Distillerie du Congo, d'une capacité de 6 millions de litres par an |
...
Le centre soigne neuf catégories de personnes, ce qui déborde largement le seul personnel de l'entreprise.

**Tableau 1.2 — Les neuf catégories de personnes prises en charge**

| Statut | Description |
|---|---|
| Personnel en contrat à durée indéterminée | Collaborateurs permanents |
| Ayants droit | Épouse et enfants des agents en contrat à durée indéterminée |
| Personnel en contrat à durée déterminée | Tâcherons et coupeurs |
| Expatriés | Personnel expatrié en mission |
| Sous-traitants | Personnel des entreprises sous-traitantes |
| Agents de la distillerie | Personnel affecté au site de la distillerie |
| Population riveraine | Habitants de la zone environnante |
...
| Niveau | Entité | Direction | Rôle |
|---|---|---|---|
| 1 | Direction des Ressources Humaines | — | Tutelle de la chaîne médicale et sociale |
| 2 | Service Médico-Social | Médecin Chef | Rattaché à la direction, il donne naissance aux deux entités opérationnelles |
...
| Fonction réelle | Rôle dans le système | Explication |
|---|---|---|
| Médecin Chef | MEDECIN_CHEF | Correspondance directe |
| Médecin | MEDECIN_CHEF | La profession de médecin est rattachée au rôle de médecin chef : il n'existe pas de rôle médecin distinct |
| Infirmière | INFIRMIER | Correspondance directe |
| — | ADMIN_SYSTEME | Rôle technique, sans équivalent dans l'organigramme : il gouverne la plateforme, non le soin |
...
| Indicateur | Valeur |
|---|---|
| Personnel de SARIS-CONGO couvert | Plus de 2 000 agents |
| Communauté desservie | Plusieurs milliers de personnes |
| Distance entre les deux sites | Plusieurs dizaines de kilomètres |
